...
export function registerUserSuccess (userDetails:Object):RegisterUserSuccessAction{
    return {
...
export function registerUserFailure (errorMessage: string) : RegisterUserFailureAction {
  return {
