        ...
        <Content padder>
          ...
          <Form>
            <Item floatingLabel last>
              <Label >Email</Label>
              <Input keyboardType='email-address' value={this.state.email} onChangeText={text=>this.setState({ email: text })} autoCorrect={false} />
            </Item>
            <Item  floatingLabel last>
         ...
         <View style = {{ padding:10, width: '100%', }}>
                <Button onPress={() => { this.submit() }} info style={{ width: '100%', }}>
